...
export default class Engine{
    ...
    hudManager() {        
    // GUI setup
    const advancedTexture = new GUI.AdvancedDynamicTexture.CreateFullscreenUI("UI", true, this.scene);
    ...
    // Energy bar
    const energyBar = new GUI.Rectangle("energyBar");
    energyBar.left = -500;
    energyBar.top = 430;
    energyBar.width = 0.2;
    ...
    // Ammo bar
    const ammoBar = new GUI.TextBlock();
    ammoBar.color = "black";
    ammoBar.fontSize = 24;
    ammoBar.top = 350;
    ammoBar.left = -500;
